...
// sysctl, modfind
extern Int VG_(sysctl)(Int *name, UInt namedlen, void *oldp, SizeT *oldlenp, void *newp, SizeT newlen);
extern Int VG_(sysctlbyname)(const HChar *name, void *oldp, SizeT *oldlenp, void *newp, SizeT newlen);
